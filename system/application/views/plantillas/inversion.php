	...
	<div class="bloques">
		<h2 class="titulouno">¿Cuál es la inversión?</h2>
		<p class="justificado">Todos los que entramos al sistema de Riqueza para Todos hacemos una sola inversión de $100 pesos.
		</p>
	</div>