	...
	<div class="bloques">
		<h2 class="titulouno">¿Qué riesgo hay en Riqueza para todos?</h2>
		<p class="justificado"><p><b>Ninguno!!</b></p>
		<p><br>
			El único riesgo eres tú, la razón más pero más importante por lo que <b>Riqueza para Todos</b> es un sistema transparente,  es porque  no existe una persona que acumule el dinero para repartirlo, todas las ayudas se hacen directamente en la cuenta de banco de los participantes, por lo tanto te pedimos que para que  tengas éxito en <b>Riqueza para Todos</b> sigas los pasos que tiene el sistema, que consideramos lo más práctico y sencillo posible para ti.
		</p>
		</p>
	</div>