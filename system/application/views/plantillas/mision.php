	...
	<div class="bloques">
		<h2 class="titulouno">Nuestra Misión</h2>
		<p class="justificado"><p>Ayudar a toda aquella persona a alcanzar una estabilidad económica que desee difundir nuestra creencia. <b><i>“Dar para poder recibir”</i></b>.
		</p>
	</div>
	<div class="bloques">
		<h2 class="titulodos">Nuestra Visión</h2>
		<p class="justificado">Promover este sistema para que muchas personas se beneficien y puedan realizar su más anhelado sueño   su <b><i>libertad financiera</i></b>. </p>
	</div>
	<div class="bloques">
		<h2 class="titulodos"><i>Ayudar para poder recibir!!</i> </h2>
		<p class="justificado">
		</p>
	</div>