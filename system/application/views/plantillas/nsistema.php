	...
	<div class="bloques">
		<h2 class="titulouno">Sistema</h2>
		<p class="justificado"><p>Riqueza para todos es una actividad que se basa en la voluntad de las personas a unirse y organizarse para dar y recibir ayuda a través  de su sistema de capitalización vía internet.</p><br>
		<p>Este sistema de capitalización o como le llamamos <b>Ayuda mutua</b> se compone de 7 ciclos en  el cual todos  los participantes inician en el <b>ciclo 1</b>.</p><br>
		<p>Cada persona que entre como <b>participante</b> tiene que cumplir con <b>2 sencillos pasos:</b></p>	
			<p>
				<ul>
					<li>1.	Dar un regalo inicial de $ 100 pesos.</li>
					<li>2.	Buscar 2 personas que deseen ser participantes  de este sistema.</li>                                                              
				</ul>
			</p>	
		</p>
	</div>